...
SVG_TIME_SIG_EX = f'<svg width="100" height="60" viewBox="0 0 100 60">{SVG_STAFF_BG}<text x="30" y="28" font-family="Arial" font-size="22" font-weight="bold" text-anchor="middle" fill="black">4</text><text x="30" y="48" font-family="Arial" font-size="22" font-weight="bold" text-anchor="middle" fill="black">4</text></svg>'
...
cards_data = [
    ...
    ("0a975e55-41c3-5077-8713-1f8c637f8b67", SVG_SLUR, "Slur: Smooth and connected (Legato)", "Articulation", "https://en.wikipedia.org/wiki/Slur", ["articulation"]),
    ...
    ("fcc07bda-2733-53d3-baaa-aefced23f8be", "Time Signature", f"Tells beats per measure and beat value<br><br>{SVG_TIME_SIG_EX}", "Rhythm", "https://en.wikipedia.org/wiki/Time_Signature", ["rhythm"]),
    ...
    ("2987ed94-399d-5606-8c46-497a5a33cdb0", SVG_TIE, "Tie: Connects same-pitch notes; play as one note for combined duration", "Rhythm", "https://en.wikipedia.org/wiki/Tie", ["rhythm"]),
    ...
    ("24ba2a7b-5d08-5f0f-8fcd-df2cf08f9142", SVG_ARPEGGIO, "Arpeggio / Rolled Chord: Notes of a chord played in quick succession", "Other", "https://en.wikipedia.org/wiki/Arpeggio", ["other"]),
    ...
    ("01915202-1121-5610-8125-8cf5c8ecaf67", "Major Second", "An interval of 2 semitones (e.g., C to D)<br><br>Ascending: Hap-[py Birth]-day<br>Descending: [Yes-ter]day (The Beatles)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("bd25baa6-b59e-5e8b-9e06-1bea368433fc", "Minor Second", "An interval of 1 semitone (e.g., C to Db)<br><br>Ascending: [Jaws] Theme<br>Descending: [Joy to] the World", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("bada120e-9fb5-5c3c-8440-89cd2e3218ec", "Major Third", "An interval of 4 semitones (e.g., C to E)<br><br>Ascending: [Oh when] the Saints<br>Descending: [Sum-mer]time", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("975becf1-f6a8-55c2-b6fb-54dfbb44be74", "Minor Third", "An interval of 3 semitones (e.g., C to Eb)<br><br>Ascending: [Green-sleeves]<br>Descending: [Hey Jude]", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("e3a55620-cd67-5b24-a01f-15c61b674267", "Perfect Fourth", "An interval of 5 semitones (e.g., C to F)<br><br>Ascending: [Here comes] the Bride<br>Descending: [Born free]", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("ec23429b-a0e0-5caa-8ea9-252884aea175", "Tritone", "An interval of 6 semitones (Augmented 4th / Diminished 5th)<br><br>Ascending: [The Simp]sons<br>Descending: Purple Haze (opening alternating notes)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("2a663145-50e8-5e9e-ab6e-5a797d36918f", "Perfect Fifth", "An interval of 7 semitones (e.g., C to G)<br><br>Ascending: Twin-[kle Twin]-kle Little Star<br>Descending: [Star Wars] (Main Theme, 3rd to 4th notes)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("cbe90e1c-74d0-5e11-98f8-34c13b9cc346", "Major Sixth", "An interval of 9 semitones (e.g., C to A)<br><br>Ascending: [I'm start]-ing with the man in the mirror<br>Descending: [Who can] take a sunrise (The Candy Man)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("1d2fc571-1ddb-5f52-834c-1136f1d3791c", "Minor Sixth", "An interval of 8 semitones (e.g., C to Ab)<br><br>Ascending: [Baker Street] (Opening Sax Riff leap)<br>Descending: [Where do] I begin? (Love Story)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("fee773a3-0475-5676-a585-a19377dd4e15", "Major Seventh", "An interval of 11 semitones (e.g., C to B)<br><br>Ascending: [Take on] me (A-ha)<br>Descending: [Hee-Haw] (Donkey braying)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("d3df7588-cb78-5d7c-8f11-a88908e1145b", "Minor Seventh", "An interval of 10 semitones (e.g., C to Bb)<br><br>Ascending: [Star Trek] Theme (Original)<br>Descending: [Wa-ter]melon Man", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"]),
    ("bc7e248f-42f0-5a4d-aa91-7dbd2f80bca7", "Perfect Octave", "An interval of 12 semitones (e.g., C to C)<br><br>Ascending: [Some-where] over the rainbow<br>Descending: [Chest-nuts] roasting (The Christmas Song)", "Interval", "https://en.wikipedia.org/wiki/Interval_(music)", ["interval"])
]
