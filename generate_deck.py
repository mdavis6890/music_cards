...
cards_data = [
    ...
    ("Accelerando (accel.)", "Gradually getting faster", "Tempo Change", ["tempo_change"]),
    ("Rallentando (rall.)", "Gradually getting slower", "Tempo Change", ["tempo_change"]),
    ("Ritardando (rit.)", "Gradually getting slower", "Tempo Change", ["tempo_change"]),
    ("Ritenuto (riten.)", "Suddenly slower, held back", "Tempo Change", ["tempo_change"]),
    ...
    ("Pianissimo (pp)", "Very soft", "Dynamics", ["dynamics"]),
    ("Piano (p)", "Soft", "Dynamics", ["dynamics"]),
    ("Mezzo-piano (mp)", "Moderately soft", "Dynamics", ["dynamics"]),
    ("Mezzo-forte (mf)", "Moderately loud", "Dynamics", ["dynamics"]),
    ("Forte (f)", "Loud", "Dynamics", ["dynamics"]),
    ("Fortissimo (ff)", "Very loud", "Dynamics", ["dynamics"]),
    ("Sforzando (sfz)", "Suddenly loud, forced", "Dynamics", ["dynamics"]),
    ("Crescendo " + SVG_CRESCENDO, "Gradually getting louder", "Dynamics", ["dynamics"]),
    ("Decrescendo / Diminuendo " + SVG_DECRESCENDO, "Gradually getting softer", "Dynamics", ["dynamics"]),
    ("Rinforzando (rfz)", "Suddenly reinforced", "Dynamics", ["dynamics"]),
    ("Staccato (dot above/below)", "Short and detached", "Articulation", ["articulation"]),
    ("Staccatissimo (𝄾)", "Very short and detached", "Articulation", ["articulation"]),
    ("Legato " + SVG_SLUR, "Smooth and connected", "Articulation", ["articulation"]),
    ("Tenuto (- above/below)", "Held for its full value", "Articulation", ["articulation"]),
    ...
    ("Alto Clef (𝄡)", "C-clef centered on 3rd line", "Symbol", ["symbol"]),
    ("Tenor Clef (𝄡)", "C-clef centered on 4th line", "Symbol", ["symbol"]),
    ...
    ("Tie " + SVG_TIE, "Connects two notes of the same pitch", "Rhythm", ["rhythm"]),
    ("Slur " + SVG_SLUR, "Connects notes of different pitches", "Rhythm", ["rhythm"]),
    ...
    ("Trill (tr)", "Rapid alternation between two notes", "Ornament", ["ornament"]),
    ...
    ("Da Capo (D.C.)", "From the beginning", "Form", ["form"]),
    ("Dal Segno (D.S.)", "From the sign", "Form", ["form"]),
    ...
    ("Octave (8va)", "Play an octave higher", "Other", ["other"]),
    ("Octave below (8vb)", "Play an octave lower", "Other", ["other"]),
    ("Con sordino", "With mute", "Other", ["other"]),
    ("Senza sordino", "Without mute", "Other", ["other"]),
    ("Arpeggio " + SVG_ARPEGGIO, "Notes of a chord played in succession", "Other", ["other"]),
...
deck = {
    ...
    "desc": "100 Music Theory Flashcards generated for Michael with categories and tempo ranges.",
    "media_files": [],
            ...
            "tmpls": [
                {
                    "name": "Card 1",
                    "ord": 0,
                    "qfmt": '<div style="font-family: Arial; font-size: 14px; color: gray; margin-bottom: 10px;">{{Category}}</div><div style="font-family: Arial; font-size: 24px; text-align: center;">{{Front}}</div>',
...
print("Done generating music_cards.json with categories and tempo ranges.")
